...
5. If a validator has failed **five times** on the same exam despite different
   fixes, stop iterating for that exam. Post a comment on the PR explaining
   the specific recurring failure and that the exam could not be brought to
   quality bar, then stop the run without pushing.
